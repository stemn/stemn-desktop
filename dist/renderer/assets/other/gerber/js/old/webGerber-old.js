...
wG.init = function init(layers, domParent) {
...
//    boardSides = new THREE.Mesh(boardSides, boardMaterial);
    boardSides = new THREE.Mesh(boardSides, new THREE.MeshFaceMaterial( [boardMaterial] ) )
...
//        console.log(demoLayers.map(function() {
