        ...
        var ProgressBar = (function ProgressBarClosure() {
            ...
            ProgressBar.prototype = {
                ...
                hide: function ProgressBar_hide() {
                    // Run parent Callback function (this is used if the viewer is in an iframe)
                    if(window.frames.parent.pdfLoadCompleteCallback){
                        window.frames.parent.pdfLoadCompleteCallback()
                    }
